            ...
            <div className="features">
                ...
                <div className="features-container">
                    <div className="feature-item">
                        <img src="/icons/drinks-icon.svg" alt="Drinks Icon" className="feature-icon" />
                        <p>Drinks, Food and Accommodation</p>
                    </div>
                    <div className="feature-item">
                        <img src="/icons/ticket-icon.svg" alt="Ticket Icon" className="feature-icon" />
                        <p>Tour Ticket</p>
                    </div>
                    <div className="feature-item">
                        <img src="/icons/transport-icon.svg" alt="Transport Icon" className="feature-icon" />
                        <p>Transportation including pickup and drop off</p>
                    </div>
                    <div className="feature-item">
                        <img src="/icons/guide-icon.svg" alt="Guide Icon" className="feature-icon" />
