                    ...
                    >
                        ...
                        {dropdownVisible && (
                            <div className="dropdown-menu">
                                <Link to="/details/candi-wringin-lawang" className="dropdown-item">Candi Wringin Lawang</Link>
                                <Link to="/details/candi-tikus" className="dropdown-item">Candi Tikus</Link>
                                <Link to="/details/candi-bajang-ratu" className="dropdown-item">Candi Bajang Ratu</Link>
