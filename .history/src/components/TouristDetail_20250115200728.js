...
const TouristDetail = () => {
    ...
    <div className="detail-container">
        ...
        <div><iframe frameborder="0" style="border:0" src="https://www.vectary.com/viewer/v1/?model=5da65d21-8845-4323-8b4c-592901e14645&amp;env=studio3&amp;turntable=2" allowfullscreen=""></iframe></div>
    </div>
    );
};
