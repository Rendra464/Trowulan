...
const Header = () => {
    ...
    const handleNavigation = (e, id) => {
        ...
        if (location.pathname !== '/') {
            // Jika tidak di halaman utama, arahkan ke halaman utama dengan state
            navigate('/', { state: { scrollTo: id } });
        } else {
            // Jika di halaman utama, langsung scroll ke bagian yang diminta
            scrollToSection(id);
        }
    };
        ...
        <header className="header">
            <div className="header-container">
                ...
                <nav className={`nav-menu ${menuVisible ? 'visible' : ''}`}>
                    ...
                    <a href="#features" onClick={(e) => { e.preventDefault(); scrollToSection('#features'); }} className="nav-item">
                        Features
                    </a>
